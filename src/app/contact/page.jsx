...
import AddressSection from "@/components/contact-page/address-section";
...
const page = () => {
  return (
    <div className="">
        ...
        <div className="flex justify-between md:flex-row flex-col gap-12">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="self-start flex flex-col gap-3">
              ...
              <a href="mailto:hi@nurona.com" className="font-semibold">
                hi@nurona.com
              </a>
            </div>
            ...
            <div className="self-start flex flex-col gap-3">
              ...
              <a href="tel:+1555000000" className="font-semibold ">
                +1 (555) 000-0000
              </a>
            </div>
      ...
      {/* previous code commented end here */}

      <section className="bg-white">
        <div className="max-w-[992px] px-4 sm:px-6 mx-auto pt-[28px]">
          <h4
            style={{ fontFamily: "TestSignifier" }}
            className="font-bold text-[38px] text-[#101828] leading-[60px] text-center pb-[20px] mw-xl:text-[32px] mw-sm4:text-[26px] mw-sm5:text-[18px] mw-sm4:leading-[46px] mw-sm5:leading-[28px] "
          >
            Contact Money Trust Currency Exchange
          </h4>
          <p
            style={{ fontFamily: "TestSignifier" }}
            className="text-[20px] leading-[30px] text-center text-[#667085] px-[86px] mw-xl:text-[18px] mw-sm4:text-[16px] mw-sm5:text-[12px] mw-sm5:leading-[16px] mw-sm4:px-[25px]  mw-sm5:px-[15px] pb-[30px] mw-sm4:pb-[20px] mw-md:px-[30px]"
          >
            For inquiries, assistance, or to learn more about our currency
            exchange services, please don't hesitate to reach out to us.
          </p>
          <p
            style={{ fontFamily: "TestSignifier" }}
            className="text-[20px] leading-[30px] text-center text-[#667085] px-[86px] mw-xl:text-[18px] mw-sm4:text-[16px] mw-sm5:text-[12px] mw-sm5:leading-[16px] mw-sm4:px-[25px]  mw-sm5:px-[15px] "
          >
            You can contact our dedicated team via the provided email or phone
            number, and we'll be delighted to address your currency-related
