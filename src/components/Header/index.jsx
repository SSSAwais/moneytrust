...
export default function Header() {
  ...
  return (
    <header
      className={`flex items-center justify-between px-6 md:py-1 py-3  ${
        scrollPosition >= 20 || isMobile
          ? "bg-white shadow-md"
          : "bg-transparent"
    ...
    >
      ...
      <nav className="hidden md:flex items-center space-x-6">
        <Link
          ...
          } ${scrollPosition >= 20 ? "" : "!text-white"} text-lg`}
        >
          Home
        </Link>
        <Link
          href="/about"
          className={`${
            pathname === "/about" ? "text-blue1 font-semibold" : "text-black"
          } ${
            scrollPosition >= 20 ? "" : "!text-white"
        ...
        <Link
          href="/services"
          className={`${
            pathname === "/services" ? "text-blue1 font-semibold" : "text-black"
          } ${
            scrollPosition >= 20 ? "" : "!text-white"
          } text-lg hover:text-blue1`}
        >
        ...
        <Link
          href="/contact"
          className={`${
            pathname === "/contact" ? "text-blue1 font-semibold" : "text-black"
          } ${
            scrollPosition >= 20 ? "" : "!text-white"
          } text-lg hover:text-blue1`}
        >
