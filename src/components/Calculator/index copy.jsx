  ...
  return (
    <div className="bg-white border border-gray-400 shadow-lg w-full rounded-[16px] h-fit lg:min-h-[513px] lg:w-[400px]">
      <div className="flex mx-auto bg-gray-200 rounded-t-[16px]">
        <div
          className={`flex-1 flex justify-center items-center py-5 px-5 md:px-0 text-sm whitespace-nowrap cursor-pointer hover:text-blue1 md:text-lg font-bold ${
            activeTab === 1 ? "border-b-2 border-blue1" : ""
          }`}
          onClick={() => {
            setActiveTab(1);
            setCartData([]);
        ...
        <div
          className={`flex-1 flex justify-center items-center py-5 px-5 md:px-0 text-sm whitespace-nowrap cursor-pointer hover:text-blue1 md:text-lg font-bold ${
            activeTab === 2 ? "border-b-2 border-blue1" : ""
          }`}
